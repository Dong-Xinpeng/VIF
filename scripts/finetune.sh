...
# TRAIN_FILE_NAME=my_train_data/pretrain_data
...
# TRAIN_FILE_NAME=ShareGPT4V/my_sharegpt4v_pretrain
...
#     --use_liger True \
#     --deepspeed scripts/zero3.json \
#     --model_id /data/dongxinpeng/my_former_work/work/checkpoint-output-self+cross_share_head/Qwen2.5-VL-7B-Instruct/my_train_data/pretrain_data/last_hidden_state_merge-with_null_vision_token-for_cycle/train_param:+inf_former \
#     --data_path $DATA_PATH \
#     --image_folder $IMAGE_FOLDER \
#     --remove_unused_columns False \
