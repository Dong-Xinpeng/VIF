...
class TrainingArguments(TrainingArguments):
    ...
    freeze_llm_head: bool = field(default=True)
    freeze_merger: bool = field(default=True)
    freeze_inf_former: bool = field(default=True)
    # freeze_vision_tower_last2: bool = field(default=True)
    ...
    inf_former_lr: Optional[float] = None
    lora_namespan_exclude: str = field(default=None, metadata={"help": "List of namespan to exclude for LoRA"})
    num_lora_modules: int = -1
    use_liger: bool = True
    my_decoder_mode: str = None
